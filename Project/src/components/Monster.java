...
public class Monster {
    ...
    public void createMonsters() { //메소드 호출 시 Monster 객체가 배열에 추가
	    ...
	    monsterList.add(new MonsterThread(1200, 450, 100, "images/monsters/슬라임괴물1.gif", player));
	    monsterList.add(new MonsterThread(1300, 400, 100, "images/monsters/책괴물7x.gif", player));	
	    monsterList.add(new MonsterThread(4500, 400, 100, "images/monsters/날개괴물7x.gif", player));		
	    monsterList.add(new MonsterThread(5600, 400, 100, "images/monsters/슬라임괴물1x4.gif", player));		
	    monsterList.add(new MonsterThread(7500, 400, 100, "images/monsters/책괴물.gif", player));		
	    monsterList.add(new MonsterThread(9600, 400, 100, "images/monsters/노란색슬라임괴물1x4.gif", player));		
	    monsterList.add(new MonsterThread(10000, 400, 100, "images/monsters/물걸레괴물7x.gif", player));		
	    ...
	    monsterList.add(new MonsterThread(12000, 400, 100, "images/monsters/물걸레괴물7x.gif", player));		
